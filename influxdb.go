...
func InfluxDB(r metrics.Registry, d time.Duration, url, database, measurement, username string) {
	InfluxDBWithTags(r, d, url, database, measurement, username, "", nil, false)
}
